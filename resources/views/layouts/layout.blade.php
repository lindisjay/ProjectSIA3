...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('home') }}"><i class="fas fa-fw fa-home"></i>
                    <span>Beranda</span></a>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-users" href="{{ route('user.index') }}"> Master User </a>
                        <a class="collapse-item fas fa-cubes" href="{{ route('barang.index') }}"> Master Barang</a>
                        <a class="collapse-item fas fa-th-large" href="{{ route('supplier.index') }}"> Master Supplier</a>
                        <a class="collapse-item fas fa-user" href="{{ route('akun.index') }}"> Master Akun</a>
                        <a class="collapse-item fas fa-cog" href="{{ route('setting.transaksi') }}"> Setting Akun</a>
                    </div>
                </div>
                @endrole
            </li>
