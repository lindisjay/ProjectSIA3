...
<div class="card-header py-3" align="right">
    <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#exampleModalScrollable"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah</button>
</div>
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <div class="card-body">
            ...
            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$spl->telepon}}</td>
                        <td align="center">
                            <a href="{{route('supplier.edit',[$spl->kd_supp])}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm rounded-pill">
                                <i class="fas fa-edit fa-sm text-white-50"></i> Edit</a>
                            <a href="/supplier/hapus/{{$spl->kd_supp}}" onclick="return confirm('Yakin Ingin menghapus data?')" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm rounded-pill">
