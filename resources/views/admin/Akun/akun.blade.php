...
1" role="dialog" aria-labelledby="exampleModalScrollableTitle" ariahidden="true">
            ...
            <form action="{{ action('AkunController@store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="addnoakun" id="addnoakun" class="formcontrol" id="exampleFormControlInput1">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlInput1">Nama Akun</label>
                        <input type="text" name="addnmakun" id="addnmakun" class="formcontrol" id="exampleFormControlInput1">
                    </div>
                </div>
