...
<form action="/detail/simpan" method="POST">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" name="no_pesan" value="{{ $formatnya }}" class="formcontrol" id="exampleFormControlInput1">
    </div>
    <div class="form-group col-sm-4">
        <label for="exampleFormControlInput1">Tanggal Transaksi</label>
        <input type="date" min="1" name="tgl" id="addnmbrg" class="formcontrol" id="exampleFormControlInput1" require>
    </div>
    <div class="form-group col-sm-4">
        <label for="exampleFormControlInput1">Supplier</label>
        <select name="supp" id="supp select2" class="formcontrol" required width="100%">
                ...
                <table class="table table-bordered tablestriped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input name="qty_pesan[]" class="formcontrol" type="hidden" value="{{$temp->qty_pesan}}" readonly>{{$temp->qty_pesan}}</td>
                            <td> <input name="sub_total[]" class="formcontrol" type="hidden" value="{{$temp->sub_total}}" readonly>{{$temp->sub_total}}</td>
                            <td align="center">
                                <a href="/transaksi/hapus/{{$temp->kd_brg}}" onclick="return confirm('Yakin Ingin menghapus data?')" class="dnone d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                        ...
                        <tr>
                            <td colspan="3"></td>
                            <td><input name="total" class="formcontrol" type="hidden" value="{{$total}}">Total {{ number_format($total) }}</a>
                            <td></td>
                            </td>
                        </tr>
                    </tbody>
            ...
            <form action="/sem/store" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="brg" id="kd_brg select2" class="formcontrol" required width="100%">
                            <option value="">Pilih</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" min="1" name="qty" id="addnmbrg" class="formcontrol" id="exampleFormControlInput1">
                    </div>
                </div>
